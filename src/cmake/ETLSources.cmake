...
if(UNIX)
	...
	if(EMSCRIPTEN)
		# no usable tty in the browser; con_tty's stdin polling never returns
		# SE_NONE and deadlocks Com_Microseconds
		LIST(APPEND PLATFORM_SRC "src/sys/con_passive.c")
		# datagrams over a WebXDC realtime channel (browsers cannot send raw
		# UDP, and a WebXDC app has no internet at all)
		LIST(APPEND PLATFORM_SRC "src/sys/net_webxdc.c")
	else()
