...
if(BUILD_CLIENT)
	...
	if(FEATURE_RENDERER1 OR FEATURE_RENDERER2 OR FEATURE_RENDERER_VULKAN)
		...
		if(EMSCRIPTEN)
			# GL via gl4es (desktop GL -> GLES2/WebGL2); GLEW is replaced by
			# renderercommon/tr_gl4es_compat.h
			set(GL4ES_ROOT "${CMAKE_SOURCE_DIR}/../tools/gl4es" CACHE PATH "Path to gl4es checkout")
			target_include_directories(opengl_renderer_libs INTERFACE "${GL4ES_ROOT}/include")
			target_link_libraries(opengl_renderer_libs INTERFACE "${GL4ES_ROOT}/lib/libGL.a")
