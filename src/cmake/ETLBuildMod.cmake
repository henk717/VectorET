...
# On Emscripten the mods are dlopen-able wasm side modules; the client is
# built as MAIN_MODULE (see ETLBuildClient.cmake)
function(etl_emscripten_side_module target_name)
	if(EMSCRIPTEN)
		target_compile_options(${target_name} PRIVATE "-sSIDE_MODULE=1")
...
if(BUILD_SERVER_MOD)
	...
	etl_emscripten_side_module(tvgame)
