...
if(EMSCRIPTEN)
	# gl4es itself is linked (once) via opengl_renderer_libs, see
	# ETLSetupFeatures.cmake; the client only needs the headers for
	# sdl_glimp.c's initialize_gl4es() call.
	target_include_directories(etl PRIVATE "${GL4ES_ROOT}/include")
	target_compile_definitions(etl PRIVATE USE_GL4ES)
	...
	target_link_options(etl PRIVATE
		...
		"-sSTACK_SIZE=8MB"
		"-sEXIT_RUNTIME=0"
		# HEAPU8: net_webxdc.c's JS side copies packets straight into the ring
		# buffer, and since Emscripten 6 the heap views are not on Module
		# unless asked for
