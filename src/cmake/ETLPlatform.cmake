...
if(NOT APPLE)
	if(EMSCRIPTEN)
		# must match ARCH_STRING/DLL_EXT in q_platform.h so Sys_GetDLLName
		# agrees with the built mod module names (cgame.mp.wasm32.wasm)
		set(ARCH "wasm32")
		set(BIN_DESCRIBE "(WebAssembly)")
		set(CMAKE_SHARED_MODULE_SUFFIX ".wasm")
	elseif(ETL_X86 AND ETL_32BITS)
		if(WIN32)
			set(ARCH "x86")
		else()
			set(ARCH "i386")
...
if(EMSCRIPTEN)
	# the client is a MAIN_MODULE (dlopen-able mod side modules), so all
	# code linked into it must be PIC
	set(CMAKE_POSITION_INDEPENDENT_CODE ON)
endif()
