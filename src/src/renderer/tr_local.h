...
#include "../renderercommon/tr_gl4es_compat.h"
#elif defined(BUNDLED_GLEW)
#include "GL/glew.h"
#else
#include <GL/glew.h>
#endif
...
#ifdef __EMSCRIPTEN__
// ushort indices keep gl4es from converting/binding an internal element
// buffer, which breaks Emscripten's client-side vertex array emulation
// (same choice as the GLES renderer; SHADER_MAX_VERTEXES 10000 < 65536)
