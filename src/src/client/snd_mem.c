...
qboolean S_LoadSound(sfx_t *sfx)
{
	...
	// ask the codecs rather than the literal name: the pak may carry this
	// sound under a different extension than the one that was requested
	if (!S_CodecResolve(sfx->soundName, NULL, 0))
	{
