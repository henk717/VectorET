...
// wasm indirect calls trap unless the signature matches the callee exactly:
// the mods define vmMain as intptr_t(intptr_t command, intptr_t arg0..arg11)
typedef intptr_t (QDECL *VM_EntryPoint_t)(intptr_t, intptr_t, intptr_t, intptr_t, intptr_t, intptr_t, intptr_t, intptr_t, intptr_t, intptr_t, intptr_t, intptr_t, intptr_t);
#else
