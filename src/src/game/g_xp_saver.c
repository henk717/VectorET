...
// XP saving needs the sqlite3-backed DBMS; without it provide no-op stubs
// so the rest of the game code links (callers are gated by the g_xpSaver
// cvar at runtime, and g_db.c - the only CheckDB caller - is DBMS-only).
